        ...
        <div style={{ background: COLORS.white, border: `1px solid ${COLORS.border}`, borderRadius: 10, padding: 24, marginBottom: 24, boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
          ...
          {existingFiles.length > 0 && (
            <div style={{ marginTop: 16 }}>
              ...
              {existingFiles.map(f => (
                <div key={f.id} className="card-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 12px', background: COLORS.bg, borderRadius: 6, marginBottom: 6 }}>
